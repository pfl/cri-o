...
replace (
	github.com/containers/podman/v4 => github.com/marquiz/podman/v4 v4.0.0-20230113164848-09b06be1adbf
	...
	k8s.io/cri-api => github.com/marquiz/kubernetes/staging/src/k8s.io/cri-api v0.0.0-20230117101610-2bab71c97f5a
